...
export default function About() {
    ...
    for (let i = 0; i < timeline.length; i++) {
      items.push(
        <motion.div 
          ...
          className={`group relative overflow-hidden rounded-[2.5rem] bg-neutral-900/50 border border-neutral-800/60 hover:border-neutral-700 transition-colors duration-500 flex ${timeline[i].layout} ${timeline[i].span} gap-8 p-10 md:p-14`}
        >
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-6 py-24 md:py-32 relative">
      <div className="mb-20">
        <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] font-bold tracking-tighter leading-[1.05] text-white mb-6">About Us</h1>

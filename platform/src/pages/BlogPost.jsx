  ...
  switch (block.type) {
    case 'h2':
      return (
        <h2
          key={index}
          className="text-2xl md:text-3xl font-black tracking-tight text-neutral-100 mt-12 mb-4 leading-tight"
        >
          {block.text}
        </h2>
      );
    case 'h3':
      return (
        <h3
          key={index}
          className="text-xl md:text-2xl font-bold tracking-tight text-neutral-200 mt-10 mb-3 leading-tight"
        >
          {block.text}
        </h3>
      );
    case 'h4':
      return (
        <h4
          key={index}
          className="text-lg font-bold text-neutral-200 mt-8 mb-2"
        >
          {block.text}
        </h4>
      );
    case 'p':
      return (
        <p
          key={index}
          className="text-base md:text-lg text-neutral-400 leading-relaxed mb-4"
        >
          {block.text}
        </p>
      );
  ...
  if (!blog) {
    return (
      <div className="w-full max-w-7xl mx-auto px-6 py-24 min-h-screen flex flex-col items-center justify-center">
        ...
        <p className="text-neutral-400 mb-8">This post doesn't exist or may have been moved.</p>
        <Link
          to="/blogs"
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-6 py-24 min-h-screen">
      <motion.button
        ...
        className="inline-flex items-center gap-2 text-sm font-medium text-neutral-500 hover:text-white transition-colors mb-12 group"
      >
      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            <span className="text-xs font-bold tracking-widest uppercase px-3 py-1.5 rounded-full bg-neutral-800 text-neutral-300">
              {blog.category}
            </span>
          ...
          <h1 className="text-3xl md:text-5xl font-black tracking-tight leading-tight text-neutral-100 mb-8">
            {blog.title}
          </h1>
        </motion.div>
        ...
        <motion.div
          ...
          className="w-full aspect-[16/9] rounded-2xl overflow-hidden mb-12 bg-neutral-900"
        >
          <img
            src={blog.thumbnail}
            alt={blog.title}
        ...
        <motion.div
          ...
          className="mt-16 p-8 rounded-2xl bg-neutral-900 border border-neutral-800 text-center"
        >
          ...
          <Link
            to="/contact"
            className="inline-flex items-center gap-3 rounded-full px-7 py-4 text-sm font-medium bg-white hover:bg-neutral-200 text-black shadow-lg transition-colors group"
          >
            Let's Talk
        ...
        {nextBlog && (
          ...
          >
            ...
            <Link
              ...
              className="group flex items-center justify-between gap-6 p-6 rounded-2xl border border-neutral-800 hover:border-neutral-600 transition-colors"
            >
              <div>
                <span className="text-xs text-neutral-400 font-medium">{nextBlog.category}</span>
                <h4 className="text-base font-bold text-neutral-200 mt-1 group-hover:text-white transition-colors leading-snug">
                  {nextBlog.title}
                </h4>
              </div>

    ...
    try {
      ...
      const res = await fetch('https://openrouter.ai/api/v1/chat/completions', {
        ...
        headers: {
          ...
          'HTTP-Referer': 'https://ascentdelta.com',
...
<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:640px;margin:0 auto;background:#fff;color:#111;">
  ...
  <div style="padding:32px;">
    ...
    <p style="font-size:12px;color:#aaa;text-align:center;margin-top:32px;">
      Generated by <strong style="color:#14b5bc;">AscentDelta AI Scan</strong> · <a href="https://ascentdelta.com" style="color:#14b5bc;text-decoration:none;">ascentdelta.com</a>
    </p>
  </div>
</div>`,
  });
